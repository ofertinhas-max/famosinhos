...
import { statusRouter as pedidoStatusRoutes, createPixRouter as createPixRoutes, webhookRouter as webhookRoutes } from './routes/pedido.js';
...
app.use((req, res, next) => {
  if (req.path.startsWith('/adminf3n1x')) {
    ...
    return res.redirect(302, '/painelad' + rest + (req.url.slice(req.path.length) || ''));
  }
  next();
});
